...
export const GROVE_PALETTES = {
  ...
  sakura: {
    ...
    ambCol: [0.11, 0.084, 0.104],

    near: { hazeCol: [0.26, 0.18, 0.205], haze: 0.34, fog: 0.06, hazeLift: 0.3 },
    far: { hazeCol: [0.14, 0.098, 0.115], haze: 0.3, fog: 0.34, hazeLift: 0.92 },

    mossDeep: [0.025, 0.03, 0.009],
    mossLit: [0.108, 0.132, 0.04],
    lichen: [0.186, 0.164, 0.148],
    grassDeep: [0.0158, 0.0186, 0.0056],
    grassMid: [0.058, 0.07, 0.0196],
    grassTip: [0.144, 0.174, 0.05],
    grassTipHi: [0.31, 0.35, 0.11],
    fernDeep: [0.0318, 0.0432, 0.015],
  ...
  maple: {
    ...
    mossDeep: [0.0262, 0.0284, 0.006],
    mossLit: [0.118, 0.1186, 0.0248],
    lichen: [0.186, 0.17, 0.118],
    grassDeep: [0.0168, 0.0166, 0.0036],
    grassMid: [0.0624, 0.0602, 0.0126],
    grassTip: [0.156, 0.142, 0.0318],
    grassTipHi: [0.33, 0.28, 0.066],
    fernDeep: [0.0342, 0.0358, 0.0102],
    fernLit: [0.088, 0.0872, 0.0262],
  ...
  sequoia: {
    ...
    mossDeep: [0.016, 0.0272, 0.008],
    mossLit: [0.0716, 0.1216, 0.0304],
    lichen: [0.15, 0.17, 0.146],
    grassDeep: [0.01, 0.0168, 0.0044],
    grassMid: [0.0384, 0.065, 0.0148],
    grassTip: [0.096, 0.1626, 0.0372],
    grassTipHi: [0.2044, 0.3408, 0.0784],
    fernDeep: [0.0212, 0.0394, 0.012],
