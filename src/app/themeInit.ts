 ...
 * The flag lives here, not in the components that need it, because <html>
 * survives client-side navigation while a component's own inline <script>
 * does not run when React creates it on the client — a soft navigation into
 * such a page would skip its intro entirely (and log the warning below).
 *
